...
export const metadata = {
  title: "SignUp | MegaMart",
  description: "MegaMart, Your shopping mall",
};

export default async function SignUpPage({ searchParams: { addtocart, addtowishlist } }) {
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 min-h-screen mx-auto lg:py-0 mt-10">
        <div className="w-full  rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 ">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <RegisterForm addtocart={addtocart} addtowishlist={addtowishlist} />
