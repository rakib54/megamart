...
export default function ShopPage() {
  return (
    <div class="container grid md:grid-cols-4 grid-cols-2 gap-6 pt-4 pb-16">
      ...
      {/* sidebar */}
      <div class="col-span-1 mt-20 bg-white px-4 pb-6 shadow rounded overflow-hidden hidden md:block">
        <div class="divide-y divide-gray-200 space-y-5">
          <div>
            <h3 class="text-xl text-gray-800 mb-3 uppercase font-medium">Categories</h3>
            <div class="space-y-2">
      ...
      <div class="col-span-3">
        <div class="mb-5 flex gap-x-4 items-center justify-end border-b p-6">
          <h6 class="text-xl text-gray-800 uppercase font-medium">Sort By :</h6>
          <select id="countries"
        ...
        {/* show product */}
        <div
          class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-2 gap-y-4 md:gap-x-6 md:gap-y-8 place-items-center">
