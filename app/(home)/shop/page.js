...
import FilterByCategory from "@/components/shop/filter/FilterByCategory";
import FilterByPrice from "@/components/shop/filter/FilterByPrice";
import FIlterBySize from "@/components/shop/filter/FIlterBySize";
import SortProducts from "@/components/shop/sort/SortProducts";
import { getProductCategory, getProducts } from "@/database/queries/product";

function refineCategory(category) {
  if (category === undefined) {  // if category is empty it returns undefined
    return "";
  }
...
export default async function ShopPage({ searchParams: { category, sort, min, max, size, q } }) {
  ...
  return (
    <div className="container grid md:grid-cols-4 grid-cols-2 gap-6 pt-4 pb-16">
      ...
      <div id="drawer-example"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <a href="#"
            ...
            access <svg className="w-4 h-4 ml-2" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd"
      ...
      {/* sidebar */}
      <div className="col-span-1 mt-20 bg-white px-4 pb-6 shadow rounded overflow-hidden hidden md:block">

        <FilterByCategory category={allCategory} />
      ...
      <div className="col-span-3">
        ...
        {products.length > 0 ? <div
          className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 lg:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-8 mb-5">
